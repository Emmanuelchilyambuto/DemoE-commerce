...
header('location:.php');
	...
	if(isset($_POST['update']))
	{
		...
		$query=mysqli_query($con,"update users set City='$City',Residence='$Residence' where id='".$_SESSION['id']."'");
		if($query)
		{
...
<div class="form-group">
			 ...
			 <input type="text" class="form-control unicase-form-control text-input" id="bilingstate" name="Residence" value="<?php echo $row['Residence'];?>" required>
				...
				<div class="form-group">
					    <label class="info-title" for="Billing State ">Contact <span>*</span></label>
			 <input type="text" class="form-control unicase-form-control text-input" id="bilingstate" name="contactno" value="<?php echo $row['contactno'];?>" required>
					  </div>
